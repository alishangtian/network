...
public class RequestTask implements Runnable {
    ...
    private final NetworkCommand request;
    private boolean stopRun = false;

    public RequestTask(final Runnable runnable, final Channel channel, final NetworkCommand request) {
    ...
    public void returnResponse(int code, String remark) {
        final NetworkCommand response = NetworkCommand.builder().remark(remark).code(code).opaque(request.getOpaque()).build();
